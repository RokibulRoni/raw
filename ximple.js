...
// this function creates a three-column table and adds it to the screen
   var numDisplayed = 0;
   var tocTable = '';
   var tocHead1 = 'আর্টিক্যাল';
   var tocTool1 = 'টাইটেল শর্টিং';
   var tocHead2 = 'প্রকাশিত';
   var tocTool2 = 'তারিখ সর্টিং';
   var tocHead3 = 'বিষয়';
   var tocTool3 = '';
   if (sortBy == "titleasc") { 
      tocTool1 += ' (অধোগামী)';
      tocTool2 += ' (প্রথমে নতুন)';
   }
   if (sortBy == "titledesc") { 
      tocTool1 += ' (ঊর্ধ্বগামী)';
   ...
   if (sortBy == "datenewest") { 
      tocTool1 += ' (ঊর্ধ্বগামী)';
      tocTool2 += ' (প্রথমে পুরাতন)';
   }
   if (postFilter != '') {
      tocTool3 = 'সবগুলো আর্টিক্যাল';
   }
   tocTable += '<table>';
   tocTable += '<tr>';
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note">সর্বমোট ' + postTitle.length + ' টি আর্টিক্যাল<br/></span>'; }
   else {
